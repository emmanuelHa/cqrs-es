...
import com.techbank.account.query.api.queries.queries.FindAccountByHolderQuery;
import com.techbank.account.query.api.queries.queries.FindAccountByIdQuery;
import com.techbank.account.query.api.queries.queries.FindAccountsWithBalanceQuery;
import com.techbank.account.query.api.queries.queries.FindAllAccountsQuery;
...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccounts() {
        try {
            ...
            var response = AccountLookupResponse.builder()
                    .accounts(accounts)
                    .message(MessageFormat.format("Sucessfully returned {0} bank account(s)", accounts.size()))
                    .build();
            return new ResponseEntity<>(response, HttpStatus.OK);
        }
        catch (Exception ex) {
            var safeErrorMessage = "Fail to complete get all accounts requests";
    ...
    public ResponseEntity<AccountLookupResponse> getAccountsById(@PathVariable(value = "id") String id) {
        try {
            ...
            var response = AccountLookupResponse.builder()
                    .accounts(accounts)
                    .message("Sucessfully returned a bank account")
                    .build();
            return new ResponseEntity<>(response, HttpStatus.OK);
        }
        catch (Exception ex) {
            var safeErrorMessage = "Fail to complete get account by id request";
            logger.log(Level.SEVERE, safeErrorMessage, ex);
            return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<AccountLookupResponse> getAccountsByHolder(@PathVariable(value = "accountHolder") String accountHolder) {
        try {
            ...
            var safeErrorMessage = "Fail to complete get account by account holder request";
            logger.log(Level.SEVERE, safeErrorMessage, ex);
            return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<AccountLookupResponse> getAccountsWithBalance(@PathVariable(value = "equalityType") EqualityType equalityType,
        ...
        try {
            ...
            var safeErrorMessage = "Fail to complete get account with balance request";
            logger.log(Level.SEVERE, safeErrorMessage, ex);
            return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
